    ...
    if request.method=='POST': 
            if user.password==request.POST['old_password']:
                if request.POST['new_password']==request.POST['cnew_password']:
                  ...
                  msg="new password and confirm password doesnot matched"
                  if user.usertype=='buyer':
                    return render(request,'change-password.html',{"msg":msg})
                  else:
                    return render(request,'seller-change-password.html',{"msg":msg})
                ...
                msg="old password doesnot matched"
                if user.usertype=='buyer':
                  return render(request,'change-password.html',{"msg":msg})
                else:
                  return render(request,'seller-change-password.html',{"msg":msg})
...
def verify_otp(request):
    ...
    querystring = {"authorization":"rNo70ysinITWJMjKl24cBeHZDApFzkVdC53PEq1fLOxRmw8Qta30t8FQOvVBsSTa9dueWNHzx162MXbP","message":"otp"+otp,"language":"english","route":"q","numbers":mobile}
